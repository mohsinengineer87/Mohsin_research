...
# ===============================
# 🔐 MITRE Threat Technique Selection & Weighting
# ===============================
st.header("📌 Select MITRE Threat Techniques")

mitre_techniques_full = [
    "Phishing",
    "Drive-by Compromise",
    "Valid Accounts",
...
selected_mitre_techniques = st.multiselect(
    "🎯 Choose relevant MITRE techniques:",
    mitre_techniques_full,
    default=[]
)

T_weight = sum(technique_weights.get(t, 1.0) for t in selected_mitre_techniques)
