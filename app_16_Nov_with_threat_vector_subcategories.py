...
# ===============================
# 🎯 Threat Vectors with Security Standard Subcategories
# ===============================
with st.expander('🎯 Threat Vectors'):
    ...
    # Calculate threat vector count for use in effort equation
    T = len(selected_vectors) if selected_vectors else 1
    st.write('Selected Threat Vectors:', selected_vectors)
