...
with st.sidebar:
    ...
    complexity_range = st.slider("Complexity (C)", 1, 5, (2, 4), help="1=Monolith, 3=Microservices, 5=Distributed Cloud/AI System")
    change_rate_range = st.slider("Change Rate (R)", 1, 5, (2, 4), help="1=Annual Updates, 3=Monthly Agile Releases, 5=CI/CD Daily")
    maturity_range = st.slider("Org Maturity (M)", 1, 10, (2, 7))
    automation_range = st.slider("Automation (Au)", 1, 5, (2, 4), help="1=Manual Excel, 3=Semi-Automated Tools, 5=CI/CD Integrated")
