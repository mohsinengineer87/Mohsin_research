...
with st.expander('🎯 Threat Vectors'):
    ...
    if threat_standard == 'MITRE ATT&CK':
        selected_vectors = st.multiselect('Select MITRE Techniques:', key='mitre_multiselect', [
            'Phishing (T1566.001)',
        ...
        selected_vectors = st.multiselect('Select ENISA Threats:', key='enisa_multiselect', [
            'Ransomware', 'Phishing', 'Data Breaches', 'Insider Threats', 'Denial of Service'
        ])
    elif threat_standard == 'VERIS':
        selected_vectors = st.multiselect('Select VERIS Threat Actions:', key='veris_multiselect', [
